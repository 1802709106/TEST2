        ...
        <div v-show="change_method_flag==1" style="height: 100%;">
          <div class="left_setting border_class" style="float: left; width: 30%;">
              ...
              <div style="margin: 10px 20px 5px 5px; width: 95%;">
                <div style="width: 100%;">
                  <template>
                    <div class="block">
                      <el-slider
                        v-model="first_data.area_choose"
                        range
                        show-stops
                        :max="first_data.choose_length">
                      </el-slider>
                    </div>
                  </template>
                </div>
                <div style="">
                  <div v-show=disabled><el-button @click="first_begin_judge" disabled style=" text-align: center;">开始诊断</el-button></div>
                  <div v-show=!disabled><el-button @click="first_begin_judge" style=" text-align: center;">开始诊断</el-button></div>
                </div>
              </div>
              ...
              <div  class="border_class" style="width: 99%;">
                ...
                <div style="display: flex;"><div style="width: 40%; text-align: right;">Ⅱ轴转速: </div><div style="width: 60%; ">{{ NumFilter(first_data.Eigenfrequency['ax_rates'][1]) }} rpm</div></div>
                <div style="display: flex;"><div style="width: 40%; text-align: right;">Ⅲ轴转速: </div><div style="width: 60%; ">{{ NumFilter(first_data.Eigenfrequency['ax_rates'][2]) }} rpm</div></div>
              </div>
              <div>
          ...
          <div class="right_four_pic" style="float: right; width: 68%;"
          v-loading="first_data.right_loading"
          element-loading-text="暂未开始诊断或诊断中"
            ...
            <div class="MLmainpart">
                        ...
                        <div>
                            <template>
                              <el-select v-model="real_model" placeholder="请在选择诊断数据和诊断特征后，选择算法模型。">
                                <el-option
                                  v-for="item in model_choose_copy"
                                  :key="item.value"
                                  :label="item.label"
                                  :value="item.value">
                                </el-option>
                ...
                <div class="judge_part border_class">
                    <div style="display: flex; padding-top: 10px; padding-bottom: 10px;">
                        ...
                        <div>
                            <div style="line-height: 40px; margin-left: 490px;">诊断结果 : {{ this.judge_result[current_error_index] }}</div>
                        </div>
                    </div>
                </div>
                <div class="buttonpart border_class"
                v-loading="judge_loading"
                element-loading-text="诊断中，请稍后。"
                element-loading-spinner="el-icon-loading"
                element-loading-background="#f5f5f5">
