    ...
    <div class="toppart">
      <div class="leftpart">
        ...
        <div class="border_class">
          ...
          <div>
            ...
            <div style="text-align: center; padding-top: 10px;">{{ NumFilter(this.Spindle_front_bearing_temperature) }}
              ℃</div>
            <div style="float: left; padding-left: 10px; padding-top: 10px;">主轴后轴承温度 : </div>
            <div style="text-align: center; padding-top: 10px;">{{ NumFilter(this.Rear_spindle_bearing_temperature) }} ℃
            </div>
            <div style="float: left; padding-left: 10px; padding-top: 10px; padding-bottom: 10px;">主轴尾轴承温度 : </div>
            <div style="text-align: center; padding-top: 10px; padding-bottom: 10px;">{{
              NumFilter(this.Spindle_tail_bearing_temperature) }} ℃</div>
          </div>
        </div>
      ...
      <div class="middlepart">
        ...
        <div class="pic" id="pic" style="width: 100%;">
          <img class="machine_pic" style="width: 100%; height: 80%; border-radius: 15px;"
            :src="getImagePath('machine_pic.jpg')" alt="Example Image">
        </div>
      </div>
        ...
        <div class="border_class">
          ...
          <div style="display: flex; text-align: center; padding-left: 10px; padding-top: 8px;">
            <div style="width: 100%;">
              ...
              <normal :status=this.Hydraulic_system_status[3] style="margin-right: 8%;"></normal>
            </div>
          </div>
          <div style="display: flex; text-align: center; padding-left: 10px; padding-top: 8px; margin-bottom: 8px;">
            <div style="width: 100%;">
              ...
              <normal :status=this.Hydraulic_system_status[4] style="margin-right: 4%;"></normal>
            </div>
          </div>
          ...
          <div>
            <div style=" margin-top: -3px;">
              <template style="display: flex;">
                <el-table :data="elc_machine_arr" style="width: 100%" :row-style="{ height: '20px' }"
